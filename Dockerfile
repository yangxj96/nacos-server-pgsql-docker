...
RUN curl -L https://github.com/alibaba/nacos/releases/download/${NACOS_VERSION}/nacos-server-${NACOS_VERSION}.tar.gz -o /home/nacos-server-${NACOS_VERSION}.tar.gz \
    && tar -C /home -xzvf /home/nacos-server-${NACOS_VERSION}.tar.gz \
    && rm -rf /home/nacos-server-${NACOS_VERSION}.tar.gz /home/nacos/bin/* /home/nacos/conf/*.properties /home/nacos/conf/*.example /home/nacos/conf/*.sql \
    && ln -snf /usr/share/zoneinfo/${TIME_ZONE} /etc/localtime && echo ${TIME_ZONE} > /etc/timezone

# 复制插件
COPY plugins/nacos-postgresql-datasource-plugin-ext-1.0.0.jar /home/nacos/plugins/nacos-postgresql.jar
